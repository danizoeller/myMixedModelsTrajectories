...
if isfield(outModelVect{iM,1}, 'groupEffect')
    if iM==1
    effectSizeGroup=table(iM, outModelVect{iM,1}.groupEffect.Chi2, outModelVect{iM,1}.groupEffect.dof_diff, outModelVect{iM,1}.groupEffect.p);
    effectSizeGroup.Properties.VariableNames={'Number of model','Chi square statistics','Degree of fredoom','p-value'};
    else 
    effectSizeGroupAdd=table(iM, outModelVect{iM,1}.groupEffect.Chi2, outModelVect{iM,1}.groupEffect.dof_diff, outModelVect{iM,1}.groupEffect.p);
